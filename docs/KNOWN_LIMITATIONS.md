# Known limitations — 0.2.0-beta.1
...
- Per-HUD-element hiding, entity/player masks, weather freezing, transparent world backgrounds, chunk preloading, burst/interval capture, batch conversion, tags/ratings editing UI, multi-select, and system sharing are not implemented in this beta.
